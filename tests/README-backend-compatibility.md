...
- **C — optional local service:** Ollama, Unsloth, llama.cpp server, or local Python-service integration. They run only when explicitly enabled and the service exists.
